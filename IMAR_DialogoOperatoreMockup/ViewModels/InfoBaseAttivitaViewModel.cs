...
namespace IMAR_DialogoOperatore.ViewModels
{
    public class InfoBaseAttivitaViewModel : ViewModelBase
    {
        ...
        public bool IsIndirettaSelezionata => _attivitaSelezionata?.IsIndiretta == true;
        ...
        public bool IsAttivitaNonSchedulata => _attivitaSelezionata != null && !IsAttivitaSaldata &&
                                             _attivitaSelezionata.DescrizioneArticolo != Costanti.FASE_INDIRETTA &&
                                             (DataSchedulata == new DateTime(1, 1, 1).ToString("dd/MM/yyyy") || DataSchedulata == null);
