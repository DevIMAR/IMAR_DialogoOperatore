...
public partial class MesDiaOpeDet
{
    public decimal Uid { get; set; }

    public decimal DiaOpeUid { get; set; }

    public decimal DecTypUid { get; set; }

    public string DocCod { get; set; }

    public decimal? DiaOpeDetRefUid { get; set; }
    ...
    public virtual MesDiaOpeDet DiaOpeDetRefU { get; set; }

    public virtual MesDiaOpe DiaOpeU { get; set; }

    public virtual ICollection<MesDiaOpeDet> InverseDiaOpeDetRefU { get; set; } = new List<MesDiaOpeDet>();
}