...
namespace IMAR_DialogoOperatore.Infrastructure.Imar_Schedulatore
{
    public class ImarSchedulatoreUoW : IImarSchedulatoreUoW
    {
        ...
        private readonly IGenericRepository<FASIINFLUSSO> _fasiInFlussoRepository;
        ...
        public IGenericRepository<FASIINFLUSSO> FasiInFlussoRepository => _fasiInFlussoRepository ?? new GenericRepository<FASIINFLUSSO>(_context);
