...
namespace IMAR_DialogoOperatore.Infrastructure.JMes
{
    public class JmesApiClient : IJmesApiClient
    {
        ...
        private const string TOKEN = "1C932DEA5A508939E219CE84617FB76F";
        ...
        public HttpResponseMessage MesAdvanceDeclaration(string badge, Attivita attivita, int quantitaProdotta, int quantitaScartata)
        {
